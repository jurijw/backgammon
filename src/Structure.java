public class Structure {
    ...
    static final int SIZE = BOARD_SIZE + 4;
    ...
    private static final int END_ZONE_END_INDEX_BLACK = (BOARD_SIZE / 4) - 1;
    /** The start index for the white end zone. */
    private static final int END_ZONE_START_INDEX_WHITE = BOARD_SIZE * 3 / 4;
    /** The start index for the black end zone. */
    private static final int END_ZONE_END_INDEX_WHITE = BOARD_SIZE - 1;
}
